...
<head>
    ...
    <!-- Vendors CSS -->
    <link rel="stylesheet" href="{{ asset('template_admin/vendor/libs/perfect-scrollbar/perfect-scrollbar.css') }}" />

    <!-- Page CSS -->

    <!-- Helpers -->
    <script src="{{ asset('template_admin/vendor/js/helpers.js') }}"></script>
    <!--! Template customizer & Theme config files MUST be included after core stylesheets and helpers.js in the <head> section -->
    <!--? Config:  Mandatory theme config file contain global vars & default theme options, Set your preferred theme option in this file.  -->
    <script src="{{ asset('template_admin/js/config.js') }}"></script>
...
<body>
    ...
    <script src="{{ asset('template_admin/vendor/libs/perfect-scrollbar/perfect-scrollbar.js') }}"></script>
    <script src="{{ asset('template_admin/vendor/js/menu.js') }}"></script>
